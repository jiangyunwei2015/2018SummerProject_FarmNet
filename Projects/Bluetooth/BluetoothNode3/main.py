...
def BlueToothFun():
    ...
    bluetooth.set_advertisement(name='LoPyServer3', service_uuid=b'1234567890123457')
    #id for this device 
    deviceID = 333
    ...
    srv1 = bluetooth.service(uuid=b'1234567890123457', isprimary=True)

    chr1 = srv1.characteristic(uuid=b'ab34567890123457', value=5)
